        ...
        <div class="col-md-12">
            <div class="panel">
                ...
                <div class="panel-heading"> {{$heading_title}}
                    <a href="/admin/album/create" class="btn btn-default btn-sm pull-right">+ Add New</a>
                </div>
                        ...
                        @foreach($list as $list_item)
                            ...
                            <td class="text-center">{{$list_item->id}}</td> -->
                                ...
                                <td>
                                    ...
                                    <a type="button" href="{{ URL('admin/album/delete/'.$list_item->id )}}" class="btn btn-info btn-outline btn-circle btn-lg m-r-5"><i class="ti-trash"></i></a>
                                    <a type="button"  href="{{ URL('admin/album/edit/'.$list_item->id )}}" class="btn btn-info btn-outline btn-circle btn-lg m-r-5"><i class="ti-pencil-alt"></i></a>
                                </td>
                            </tr>
                        @endforeach
