...
@section('breadcrumb')
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="/admin/banners/category">Banners</a></li>
...
@section('content')
    ...
    <div class="row">
        @if(isset($mthoad))
            @if($mthoad==1)
                <form method="post" action="{{ route('bannerscategory.store') }}" class="form-horizontal" >
                    @elseif($mthoad==2)
                        <form method="post" action="{{ route('bannerscategory.update') }}" class="form-horizontal" >
                            @endif
                            @endif
                            <div class="col-md-9">
                                <div class="white-box">
